...
if (isset($_GET['profile_id'])){
    $pid = $_GET['profile_id'];
    $qry = "SELECT * FROM users WHERE id='$pid'";
    $data = $con->query($qry);
...
<head>
	<meta charset="UTF-8">
	<title>Profile || <?php echo $pdata['fname'] . ' ' .$pdata['lname'];?></title>
	<!-- ALL CSS FILES  -->
				...
				<div class="col-md-12">
					<div class="cover-profile-photo">
						<div class="profile-photo">
							<img class="shadow-sm" src="photo/<?php echo $pdata['photo'];?>" alt="">
						</div>
					</div>
					<div class="user-info">
						<h2><?php echo $pdata['fname'].' '.$pdata['lname'];?></h2>
					...
					<div class="profile-menu clearfix">
						...
						<div class="right-menu float-right">
							<a href="#"><i class="fab fa-facebook-messenger"></i> Message</a>
							<a href="#"><i class="fas fa-phone-alt"></i></a>
							<a href="#"><i class="fas fa-user-friends"></i></i></a>
							...
							<div class="card shadow-sm">
								<div class="card-body">
									<div class="post-header clearfix">
										<img src="photo/<?php echo $pdata['photo'];?>" alt="">
										<div class="post-user-info">
											<h4><a href="#"><?php echo $pdata['fname'] . ' '. $pdata['lname'];?></a></h4>
									...
									<div class="comment-area">
										...
										<div class="post-user-comment clearfix">
											...
											<div class="comment-content">
												<h4><?php echo $pdata['fname'].' '.$pdata['lname'];?></h4>

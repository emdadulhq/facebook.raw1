...
<head>
	<meta charset="UTF-8">
	<title><?php echo $_SESSION['name'];?> | Facebook</title>
	<!-- ALL CSS FILES  -->
			...
			<div class="modal-content ">
				<div class="modal-body">
					...
					<div class="post-user-details clearfix">
						<img src="photo/<?php echo $_SESSION['photo'];?>" alt="profile.php">
			...
			<div class="row">
				...
				<div class="col-md-4 clearfix">
					<div class="user-info-top float-left clearfix">
						<img src="photo/<?php echo $_SESSION['photo'];?>" alt="profile.php">
						<a href="profile.php?"><h4><?php echo $_SESSION['name'];?></h4></a>
					</div>
						...
						<ul>
							...
							<div class="card" style="width: 24rem;">
							  <div class="card-body row">
								  <div class="col-lg-3">
									  <a href=""><img class="card-img-top" style="height: 70px; width: 70px; border-radius: 50%; display: block;" src="assets/media/img/pp_photo/300x300.jpg" alt="Card image cap"></a>
								  </div>
			...
			<div class="row">
				...
				<div class="col-md-7">
					...
					<div class="all-post-area">
                        ...
                        $udata = $con ->query($qry);
                        while ($user_data = $udata->fetch_assoc()):
								...
								<div class="card-body">
									<div class="post-header clearfix">
										...
										<div class="post-user-info">
											<h4><a href="view.php?profile_id=<?php echo $user_data['id'];?>"><?php echo $user_data['fname'] .' '.$user_data['lname'];?></a></h4>

...
if (isset($_GET['delete_id'])){
    ...
    $qry = "DELETE FROM users WHERE id = '$did'";
    $con -> query($qry);

    unlink('photo/' . $_SESSION['photo']);
    session_destroy();
			...
			<div class="modal-content ">
				<div class="modal-body">
					...
					<div class="post-user-details clearfix">
						<img src="photo/<?php echo $_SESSION['photo'];?>" alt="">
			...
			<div class="row">
				...
				<div class="col-md-4 clearfix">
					<div class="user-info-top float-left clearfix">
                        <a href="profile.php"><img src="photo/<?php echo $_SESSION['photo'];?>" alt="">
                            <h4><?php echo $_SESSION['name'];?></h4></a>
					</div>
					<div class="notification-bar float-right">
						<ul>
							...
							<li><a href="#"><i data-toggle="collapse" data-target="#demo" class="fas fa-caret-down"></i></a></li>

							<div id="demo" class="collapse bg-info">
								<div class="card " style="width: 24rem;">
									<div class="card-body row">
										<div class="col-lg-3">
											<a href=""><img class="card-img-top" style="height: 70px; width: 70px; border-radius: 50%; display: block;" src="photo/<?php echo $_SESSION['photo'];?>" alt="Card image cap"></a>
										</div>
									...
									<ul class="list-group list-group-flush text-left">
										<a href=""><li class="list-group-item"><i class="fas fa-cog"></i> Settings & privacy</li></a>
										<a href=""><li class="list-group-item"><i class="fas fa-question-circle"></i> Help & Support</li></a>
										<a href=""><li class="list-group-item"><i class="fas fa-moon"></i> Dark Mode <i class="fas fa-toggle-on "></i></li></a>
										<a href=""><li class="list-group-item"><i class="fas fa-exchange-alt"></i> Switch to Basic Mode</li></a>
										<a href="?logout=ok"><li class="list-group-item"><i class="fas fa-sign-out-alt"></i> Log Out</li></a>
				...
				<div class="col-md-12">
					<div class="cover-profile-photo">
						<div class="profile-photo">
							<img class="shadow-sm" src="photo/<?php echo $_SESSION['photo'];?>" alt="">
						</div>
					</div>
					<div class="user-info">
						<h2><?php echo $_SESSION['name'];?></h2>
...
if (isset($_POST['send'])){
    ...
    if (empty($fname) || empty($lname) || empty($email) || empty($phone)){
        $mess = msgvld('All fields are required');
    }else{
        if (!empty($_FILES['new_photo']['name'])){
            $photo_data = photoUpload($_FILES['new_photo'], 'photo/', ['jpg','png','gif','jpeg'], '500');
            $mess = $photo_data ['mess'];
            $photo_name = $photo_data ['file_name'];
        }else{
            $photo_name = $_POST['old_photo'];
        }
        $upqry= "UPDATE users SET fname='$fname', lname='$lname', email='$email', phone='$phone', dob='$dob', gender='$gender',photo='$photo_name' WHERE id='$updtid'";
        $con->query($upqry);
        $mess = msgvld('Profile updated successfull', 'success');
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            300px;
                                            border-radius: 50%; left: 0; top: 0; margin: auto; display: block;" src="photo/<?php echo $disdata['photo'];?>" alt="">
                                            <form action="" method="POST" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    <label for="">First Name</label>
                                                    <input name="fname" value="<?php echo $disdata['fname']; ?>" class="form-control" type="text">
                                                </div>
                                                <div class="form-group">
                                                    <label for="">Last Name</label>
                                                    <input name="lname" value="<?php echo $disdata['lname']; ?>" class="form-control" type="text">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="phone" value="<?php echo $disdata['phone']; ?>" class="form-control" type="text">
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <a href="change_password.php" class="btn btn-danger">Change Password</a> <br>

                                        <a href="?delete_id=<?php echo $_SESSION['id'];?> " id="del_btn" class="btn btn-danger">Deactive my account</a>
								...
								<div class="all-frield clearfix">
									...
									<div class="frield-item">
										<a href="#">
											<div class="card">
												<div class="card-body">
													<img class="w-100" src="photo/<?php echo $_SESSION['photo'];?>" alt="">
												</div>
								...
								<div class="card-body">
									...
									<div class="comment-area">
										...
										<div class="post-comment clearfix">
											<img class="float-left" src="photo/<?php echo $_SESSION['photo'];?>" alt="">
